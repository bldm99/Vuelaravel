					...
					<li class="dropdown cart-nav dropdown-slide">
						...
						<div class="dropdown-menu cart-dropdown">
							...
							<ul class="text-center cart-buttons">
								<li><a href="cart.blade.php" class="btn btn-small">View Cart</a></li>
							...
							<div class="row">
								...
								<div class="col-lg-6 col-md-6 mb-sm-3">
									<ul>
										...
										<li><a href="confirmation.blade.php">Confirmation</a></li>
                     ...
                     <div class="payment">
                        <div class="card-details">
                           <form  class="checkout-form">
                              ...
                              <a href="confirmation.blade.php" class="btn btn-main mt-20">Place Order</a >
                           </form>
                        </div>
                     </div>
                  </div>
...
<form method="Post" action="{{url('adddetalle',$pru->id)}}">

    @csrf
    @method("PUT")
    <div class="form-group">
        <label for="nombre">Nombre</label>
        <input type="text" class="form-control" name="nombre" required  value="{{$pru->id}}">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="producto" required value="{{$pru->nombre}}">
    </div>
    <div class="form-group">
        <label for="precio">Precio</label>
        <input type="text" class="form-control" name="precio" required value="{{$pru->precio}}">
    </div>
    <div class="form-group">
