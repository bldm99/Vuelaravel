			...
			<div class="col-md-4">
				<div class="product-item">
					<div class="product-thumb">
						...
						<img class="img-responsive" src="{{$item1->imagen}}" alt="product-img" />
						<div class="preview-meta">
							<ul>
								...
								<li>
			                        <a href="#!" ><i  type="submit" class="tf-ion-ios-heart"></i></a>
								</li>
								<li>
                                        ...
                                        <div class="form-group">
                                            @guest
                                                @if (Route::has('login') )
                                                    ...
                                                    <a href="{{route('register')}}" ><i  class="tf-ion-android-cart"></i></a>

                                                @endif
                                            @else


                                                <a><i class="tf-ion-android-cart"><button type="submit"></button></i></a>
    ...
    <form method="post" action="{{url('addcarrito')}} " enctype="multipart/form-data">
        ...
        <div class="form-group">
            @guest
                @if (Route::has('login') )
                    <p>No puedes comprar</p>
                    <a href="{{route('register')}}" class="btn btn-success">Agrrgar al carrito</a>
                @endif
            @else
                <p>comprar ya </p>
